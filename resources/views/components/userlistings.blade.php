...
<table class="pretty table table-bordered table-striped" style="width:81%"> 
<thead>
            <tr>
                <th width="10%"></th>
  ...
  <tbody>
                                               ...
                                               @forelse($listings as $listing)
                                                ...
                                                <td ;="" align="center">-</td>
                                                 <td><a href="https://caworksite.com/Weedulu/index.php/mylisting/pricing/4"><button class="button md">Upgrade</button></a></td>   

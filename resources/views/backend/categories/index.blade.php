                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                       <a class="btn btn-small btn-info" href="{{ url('admin/categories/edit/' . $category->id ) }}">Edit</a>
  |                         <a class="btn btn-small btn-info" href="{{ url('admin/categories/destroy/' . $category->id ) }}">Delete</a>
